            ...
            @foreach($activitys as $key=>$activity)
                <div class="col-sm-4 col-md-3">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <div>
                                <label>类别：</label>@if( $activity['sort'] == 0 )技术研发中心@elseif( $activity['sort'] == 1 )
                                    文化传媒中心@elseif( $activity['sort'] == 2 )运营策划中心@endif
                            </div>
                            <div>
                            ...
                            <p>
                                {{--<a href="javascript:void(0);" class="btn btn-info " data-toggle="modal" data-target="#myModal"--}}
                                   {{--role="button">编辑</a>--}}
                                <a href="javascript:void(0);" onclick="del( {{ $activity->id }} )" class="btn btn-danger"
                                   role="button">删除</a>
                            </p>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" role="form" action="{{ url('admin/CenterAct') }}" method="post"
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 200) {
                        ...
                        window.location.href = "{{ url('admin/CenterAct') }}";
